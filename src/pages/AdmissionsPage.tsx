...
export const AdmissionsPage: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-16">
      {/* Hero Banner */}
      <div className="w-full page-banner py-14 px-4 text-center text-white">
        <div className="max-w-4xl mx-auto space-y-3">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-amber-500/20 text-amber-300 border border-amber-400/30 mb-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 space-y-12">
        ...
        <div className="bg-gradient-to-r from-[#071526] via-[#0B1E36] to-[#16325B] text-white p-6 sm:p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 border border-amber-400/30">
          <div className="space-y-2">
            <span className="inline-block px-3.5 py-1 bg-amber-500 text-slate-950 font-extrabold text-xs rounded-full uppercase tracking-wider shadow">
              Admissions Now Open
            </span>
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              to="/forms"
              className="bg-white/10 hover:bg-white/20 text-white font-bold py-3 px-6 rounded-xl text-xs border border-white/20 transition-all text-center"
            >
              Download Forms
            </Link>
            <Link
              to="/contact-us"
              className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-extrabold py-3 px-6 rounded-xl text-xs transition-all text-center shadow-md uppercase tracking-wider"
            >
              Contact Office
            </Link>
          </div>
