    ...
    <div className="bg-slate-50 min-h-screen pb-16">
      ...
      <div className="w-full bg-[#002147] py-12 px-4 text-center text-white border-b-4 border-[#17a2b8]">
        <div className="max-w-4xl mx-auto space-y-3">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 mb-2">
          ...
          <p className="text-sky-200 text-sm sm:text-base max-w-2xl mx-auto">
            Annual festivals, educational camps, picnics, and national day observances at Shree Siddhi Vinayagar English High School.
          </p>
        </div>
      </div>
