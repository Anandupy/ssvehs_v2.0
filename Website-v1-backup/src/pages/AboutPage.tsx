  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        {/* About Info Grid */}
        <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-gray-100 mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-4">
              <span className="inline-block px-3 py-1 bg-sky-100 text-sky-800 font-bold text-xs rounded-full uppercase tracking-wider">
                Our Heritage & Ideals
              </span>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-[#002147] tracking-tight">
                Know More About Us
              </h1>
            ...
            <div className="lg:col-span-5 flex flex-col items-center">
              <div className="relative w-full max-w-sm flex flex-col items-center">
                <div className="w-48 h-48 sm:w-56 sm:h-56 rounded-full overflow-hidden border-4 border-sky-500 shadow-lg z-10 bg-sky-50">
                  <img
                ...
                <div className="flex justify-between w-full -mt-16 z-20 px-2">
                  <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-full overflow-hidden border-4 border-white shadow-md bg-white">
                    <img
        ...
        <div className="mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {facilities.map((fac, idx) => (
              ...
              >
                <div className="w-14 h-14 shrink-0 rounded-lg bg-sky-50 p-2.5 flex items-center justify-center border border-sky-100">
                  <img
                    src={fac.img}
                    alt={fac.title}
